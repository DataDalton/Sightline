...
interface Options {
	// Strips the colours so the mark takes the colour of the text beside it,
	// which is what makes one file work in both themes.
	adaptive?: boolean;
}

export interface SvgResult {
	markup: string;
	// Reported so an upload can say what it did rather than silently changing
	// the file someone chose.
