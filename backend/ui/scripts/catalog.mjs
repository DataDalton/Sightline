// Generated from lib/visuals/catalog.ts by "npm run build:scripts". Do not edit.
...
export const visualCatalog = [
    // --- Summary -----------------------------------------------------------
    {
        ...
        label: "KPI tiles",
        category: "summary",
        guidance: "Headline figures with no breakdown. Use for the handful of numbers a reader should see first.",
    ...
    },
    {
        ...
        label: "Gauge",
        category: "summary",
        guidance: "A single value against a target. Only worth it when the target is meaningful; otherwise a KPI tile says the same thing in less space.",
    ...
    // --- Comparison --------------------------------------------------------
    {
        ...
        label: "Bar chart",
        category: "comparison",
        guidance: "Compare a measure across categories. The default choice for ranking.",
        encoding: {
    ...
    },
    {
        ...
        category: "comparison",
        guidance: "Same as a bar chart but with room for long category names, which is most of the time in practice.",
        encoding: {
    ...
    },
    {
        ...
        category: "comparison",
        guidance: "Two measures on different scales, such as revenue as bars with a percentage as a line. Set the line series to the right axis.",
        encoding: {
    ...
    // --- Trend -------------------------------------------------------------
    {
        ...
        label: "Line chart",
        category: "trend",
        guidance: "A measure over time. Put the date dimension first; the view already carries prior-period measures if you need a comparison.",
        encoding: {
    ...
    },
    {
        ...
        label: "Area chart",
        category: "trend",
        guidance: "A trend where the volume matters as much as the direction. Stack it only when the total is meaningful.",
        encoding: {
            dimensions: { min: 1, max: 2 },
            measures: { min: 1, max: 6 },
        },
    ...
    },
    {
        ...
        label: "Waterfall",
        category: "trend",
        guidance: "How a total was built up or eroded, step by step. Reads well for bridges between two periods.",
        encoding: {
            dimensions: { min: 1, max: 1 },
    ...
    // --- Composition -------------------------------------------------------
    {
        ...
        guidance: "Parts of a whole, at most five or six slices. People compare angles poorly, so a bar chart is usually the better answer.",
        encoding: {
            dimensions: { min: 1, max: 1 },
            measures: { min: 1, max: 1 },
        },
    ...
    },
    {
        ...
        label: "Donut chart",
        category: "composition",
        guidance: "A pie with the total in the middle. Same caution about slice counts applies.",
        encoding: {
            dimensions: { min: 1, max: 1 },
            measures: { min: 1, max: 1 },
        },
    ...
    },
    {
        ...
        label: "Treemap",
        category: "composition",
        guidance: "Composition with many categories, where a pie would be unreadable. Area encodes the measure.",
        encoding: {
            dimensions: { min: 1, max: 2 },
            measures: { min: 1, max: 1 },
        },
    ...
    },
    {
        ...
        label: "Funnel",
        category: "composition",
        guidance: "Stages that narrow, such as a pipeline. The order of the dimension is the order of the stages.",
        encoding: {
            dimensions: { min: 1, max: 1 },
            measures: { min: 1, max: 1 },
        },
    ...
    },
    {
        ...
        category: "composition",
        guidance: "Share of total across categories, where the mix matters more than the size.",
        encoding: {
            dimensions: { min: 1, max: 2 },
    ...
    // --- Distribution and relationship -------------------------------------
    {
        ...
        guidance: "Whether two measures move together. Add a second measure for the second axis.",
        encoding: {
            dimensions: { min: 1, max: 1 },
    ...
    },
    {
        ...
        guidance: "One measure across two dimensions, such as month by product. Colour encodes the value.",
        encoding: {
    ...
    },
    {
        ...
        label: "Radar",
        category: "distribution",
        guidance: "Several measures compared across a few categories. Hard to read past three or four series.",
        encoding: {
            dimensions: { min: 1, max: 1 },
    ...
    // --- Detail ------------------------------------------------------------
    {
        ...
        label: "Table",
        category: "detail",
        guidance: "The exact figures, with sorting, per-column filters and export. Use when a reader needs to look something up rather than see a shape.",
    ...
    },
    {
        ...
        category: "detail",
        guidance: "A hierarchy down the left that expands level by level, with an optional dimension pivoted across the top. Order the row fields outermost first, such as Year then Division then Business Unit.",
        encoding: {
            dimensions: {
                min: 1,
                max: 5,
    ...
    },
    {
        ...
        label: "Detail panel",
        category: "detail",
        guidance: "Everything known about a single record, laid out as label and value.",
    ...
    // --- Filters -----------------------------------------------------------
    {
        ...
        category: "filter",
        guidance: "Repoints every visual on the page that uses the breakdown placeholder. One chart plus this control replaces a page per breakdown.",
        encoding: {
    ...
    },
    {
        ...
        category: "filter",
        guidance: "Offers month, quarter and year as a choice rather than as three pages. Repoints the same visuals the breakdown switcher does.",
        encoding: {
    ...
    },
    {
        ...
        label: "Filter group",
        category: "filter",
        guidance: "One dropdown per field, kept together. For a page where readers narrow by several things at once.",
        encoding: {
    ...
    },
    {
        ...
        label: "Threshold",
        category: "filter",
        guidance: "Keeps rows where a measure clears a cutoff the reader sets. For \"orders above\" and \"anything under\" questions.",
        encoding: {
    ...
    },
    {
        ...
        category: "filter",
        guidance: "Pick one or several values for a field. Values are read from the data and narrow as other filters are applied.",
        encoding: {
    ...
    },
    {
        ...
        label: "Search box",
        category: "filter",
        guidance: "Free text matched across the fields you choose. Case-insensitive contains.",
        encoding: {
    ...
    },
    {
        ...
        category: "filter",
        guidance: "Paste a list of ids or codes and match any of them. For the case where someone arrives with a spreadsheet column.",
        encoding: {
            dimensions: { min: 1, max: 1 },
            measures: { min: 0, max: 0 },
        },
    ...
    },
    {
        ...
        label: "Entity header",
        category: "detail",
        guidance: "The identifying attributes of the one thing a detail page is about, laid out as a header rather than a table.",
        encoding: {
    ...
    // --- Text --------------------------------------------------------------
    {
        ...
        label: "Text panel",
        category: "text",
        guidance: "A note, caveat or definition. Worth adding wherever a number needs explaining.",
        encoding: {
    ...
    },
    {
        ...
        category: "text",
        guidance: "States what a page is waiting on. Better than an empty page, which reads as broken rather than as not built yet.",
        encoding: {
            dimensions: { min: 0, max: 0 },
            measures: { min: 0, max: 0 },
        },
...
export const visualByType = Object.fromEntries(visualCatalog.map((v) => [v.type, v]));
export function isFilterVisual(type) {
...
export function isPageControl(type) {
...
export function checkEncoding(type, dimensions, measures) {
    ...
    if (dimensions.length < d.min) {
        ...
        return {
            kind: "missing",
            field: "dimensions",
            message: `Add ${need} more ${need === 1 ? "dimension" : "dimensions"}${d.label ? ` (${d.label})` : ""}`,
        };
    }
    ...
    if (dimensions.length > d.max) {
        return {
            kind: "excess",
            field: "dimensions",
            message: `This visual uses at most ${d.max} ${d.max === 1 ? "dimension" : "dimensions"}`,
        };
    }
    if (measures.length > m.max) {
        return {
            kind: "excess",
            field: "measures",
            message: `This visual uses at most ${m.max} ${m.max === 1 ? "measure" : "measures"}`,
        };
    }
    return null;
}
...
export function fillsHeight(type, options) {
    if (!visualByType[type]?.supports.fillHeight)
        return false;
